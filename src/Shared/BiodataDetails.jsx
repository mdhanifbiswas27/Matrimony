...
const BiodataDetails = ({item}) => {

    const { Name, BiodataID,_id, ProfileImage, PermanentDivision, Age, Occupation, BiodataType } = item;
    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="p-5">
            ...
            <div className="flex justify-end">
                <div>
                    <Link to={`/biodataDetails/${_id}`}><p  className=" justify-end inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#ff9902] rounded-lg hover:bg-[#ff9902] focus:ring-4 focus:outline-none ">
                        View Profile
                        {/* {`/update/${_id}`} */}
